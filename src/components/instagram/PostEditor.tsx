...
import { Plus, Trash2, RotateCcw, Upload, X, ChevronDown, Move } from "lucide-react";
  ...
  return (
    <Card className="max-h-[calc(100vh-200px)] overflow-y-auto">
      ...
      <CardContent className="space-y-6">
        ...
        {/* Font Settings */}
        <Collapsible open={expandedSections.fonts} onOpenChange={() => toggleSection("fonts")}>
          <CollapsibleTrigger asChild>
            <Button variant="ghost" className="w-full justify-between px-2">
              <span className="font-medium">Font Settings</span>
              <ChevronDown className={`w-4 h-4 transition-transform ${expandedSections.fonts ? "rotate-180" : ""}`} />
            </Button>
          </CollapsibleTrigger>
          <CollapsibleContent className="space-y-4 pt-2 p-4 border rounded-lg bg-muted/30">
        ...
        <Collapsible open={expandedSections.qr} onOpenChange={() => toggleSection("qr")}>
          <CollapsibleTrigger asChild>
            <Button variant="ghost" className="w-full justify-between px-2">
              ...
              <ChevronDown className={`w-4 h-4 transition-transform ${expandedSections.qr ? "rotate-180" : ""}`} />
            </Button>
          </CollapsibleTrigger>
          <CollapsibleContent>
            {content.qrCode && (
        ...
        {/* Event Auto-fill */}
        <Collapsible open={expandedSections.event} onOpenChange={() => toggleSection("event")}>
          <CollapsibleTrigger asChild>
            <Button variant="ghost" className="w-full justify-between px-2">
              <span className="font-medium">Auto-fill from Event</span>
              <ChevronDown className={`w-4 h-4 transition-transform ${expandedSections.event ? "rotate-180" : ""}`} />
            </Button>
          </CollapsibleTrigger>
          <CollapsibleContent>
        ...
        <Collapsible open={expandedSections.ai} onOpenChange={() => toggleSection("ai")}>
          <CollapsibleTrigger asChild>
            <Button variant="ghost" className="w-full justify-between px-2">
              <span className="font-medium">AI Text Suggestions</span>
              <ChevronDown className={`w-4 h-4 transition-transform ${expandedSections.ai ? "rotate-180" : ""}`} />
            </Button>
          </CollapsibleTrigger>
          <CollapsibleContent>
            <AISuggestions
