...
export const STARTER_TEMPLATES: Array<{
  ...
  {
    name: "Party Panther Story",
    description: "Deep-blue radial background, cyan corner-bracket chrome, neon pill buttons — matches the animated reel.",
    settings: createTemplate({
      headline: "FIND EVENTS.\nHAVE AN EVENT?\nPOST IT.",
      sections: [
        { subheadline: "// FIND YOUR PARTY", body: "" },
      ],
      format: "story",
      background: { style: "deep-blue-radial", opacity: 0 },
      fonts: { headline: "Bebas Neue", subheadline: "Poppins", body: "Poppins" },
      fontSizes: { headline: 88, subheadline: 28, body: 20 },
      positions: {
        headline: { x: 50, y: 45 },
        sections: [{ x: 50, y: 32 }],
      },
      textStyles: {
        colors: { headline: "#5BE9FF", subheadline: "#7AA8C9", body: "#cdd9ea" },
        shadows: {
          headline: { enabled: true, color: "#00CFFF", blur: 30, offsetX: 0, offsetY: 0 },
          subheadline: { ...DEFAULT_SHADOW },
          body: { ...DEFAULT_SHADOW },
        },
        strokes: {
